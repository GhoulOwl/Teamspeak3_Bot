...
class VoiceClientTracker:
    ...
    def subscribe(self) -> None:
        """Register event handlers and perform initial sync."""
    ...
    async def initial_sync(self) -> None:
        """Find the voice client on startup and move ServerQuery to its channel."""
    ...
    async def _do_move(self, clid: int, channel_id: int) -> None:
        """Execute the move with a small debounce."""
        try:
